...
class AppLocalizations {
  ...
  static const Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      'provider_ollama': 'OLLAMA QWEN3 8B',
      'provider_deterministic': 'DETERMINISTIC FALLBACK',
      'scenario_estimate_label': 'PRAHAR Scenario Estimate (Simulation Demo)',
      'scenario_estimate_disclaimer': 'Scenario estimates are simulated predictive projections, not guaranteed outcomes.',
      'evidence_breakdown_title': 'Agronomic Evidence Breakdown',
      'metric_col': 'Metric',
      'observed_col': 'Observed',
      'threshold_col': 'Threshold',
      'status_col': 'Status',
      'voice_listening': 'Listening... Speak now',
      'voice_processing': 'Processing voice with PRAHAR AI...',
      'voice_tap_to_speak': 'Tap Mic to Speak',
      'voice_not_available': 'Voice STT/TTS not supported on this platform. Text fallback active.',
      'scenarios_title': 'Deterministic Demo Scenarios',
      'demo_scenarios_title': 'Deterministic Demo Scenarios',
      'reset_field_btn': 'Reset Field State',
      'reset_scenario': 'Reset Field State',
      'judge_mode_title': 'Judge Mode',
      'judge_mode_badge': '12-STEP FLOW',
      'judge_mode_subtitle': 'Step-by-step hackathon evaluation flow across 12 verified checkpoints.',
      'judge_mode_btn': 'Judge Mode (12-Step Flow)',
      'judge_mode_step': 'Step',
      'judge_mode_next': 'Next Step',
      'judge_mode_reset': 'Reset & Try Another Scenario',
      'assistant_listening': 'Listening... Speak now',
      'assistant_chip_prediction': 'Predict zone outcome',
      'assistant_chip_analysis': 'Full field agronomic analysis',
      'assistant_chip_compare': 'Compare Zone 1 vs Zone 2',
      'assistant_prediction_disclaimer': 'PRAHAR Scenario Estimate • Indicative Simulation',
      'evidence_breakdown': 'Agronomic Evidence Breakdown',
    },
    ...
    'hi': {
      ...
      'provider_ollama': 'ओलामा क्वेन3 8B',
      'provider_deterministic': 'निश्चित प्रहार इंजन',
      'scenario_estimate_label': 'प्रहार परिदृश्य अनुमान (सिम्युलेशन डेमो)',
      'scenario_estimate_disclaimer': 'परिदृश्य अनुमान सिम्युलेटेड भविष्यसूचक प्रक्षेपण हैं, गारंटीकृत परिणाम नहीं।',
      'evidence_breakdown_title': 'कृषि साक्ष्य विवरण',
      'metric_col': 'मापदंड',
      'observed_col': 'प्रेक्षित',
      'threshold_col': 'मानक सीमा',
      'status_col': 'स्थिति',
      'voice_listening': 'सुन रहा है... अब बोलें',
      'voice_processing': 'प्रहार एआई से आवाज का विश्लेषण हो रहा है...',
      'voice_tap_to_speak': 'बोलने के लिए माइक दबाएं',
      'voice_not_available': 'आवाज सेवा अनुपलब्ध है, टेक्स्ट मोड सक्रिय है।',
      'scenarios_title': 'निश्चित डेमो परिदृश्य',
      'demo_scenarios_title': 'निश्चित डेमो परिदृश्य',
      'reset_field_btn': 'खेत स्थिति रीसेट करें',
      'reset_scenario': 'खेत स्थिति रीसेट करें',
      'judge_mode_title': 'जज मोड',
      'judge_mode_badge': '12-चरण मूल्यांकन',
      'judge_mode_subtitle': 'हैकथॉन जजों के लिए 12 सत्यापित चरणों का मूल्यांकन प्रवाह।',
      'judge_mode_btn': 'जज मोड (12 चरण)',
      'judge_mode_step': 'चरण',
      'judge_mode_next': 'अगला चरण',
      'judge_mode_reset': 'रीसेट करें और दूसरा परिदृश्य चुनें',
      'assistant_listening': 'सुन रहा है... अब बोलें',
      'assistant_chip_prediction': 'ज़ोन परिणाम का अनुमान',
      'assistant_chip_analysis': 'सम्पूर्ण खेत कृषि विश्लेषण',
      'assistant_chip_compare': 'ज़ोन 1 बनाम ज़ोन 2 तुलना',
      'assistant_prediction_disclaimer': 'प्रहार परिदृश्य अनुमान • सांकेतिक सिमुलेशन',
      'evidence_breakdown': 'कृषि साक्ष्य विवरण',
    },
    ...
    'mr': {
      ...
      'provider_ollama': 'ओलामा क्वेन3 8B',
      'provider_deterministic': 'निश्चित प्रहार इंजिन',
      'scenario_estimate_label': 'प्रहार परिस्थिती अंदाज (सिम्युलेशन डेमो)',
      'scenario_estimate_disclaimer': 'परिस्थिती अंदाज हे केवळ सिम्युलेटेड संभाव्य अंदाज आहेत, खात्रीशीर निष्कर्ष नाहीत.',
      'evidence_breakdown_title': 'कृषी पुरावा तपशील',
      'metric_col': 'मापदंड',
      'observed_col': 'नोंदवलेले',
      'threshold_col': 'मर्यादा',
      'status_col': 'स्थिती',
      'voice_listening': 'ऐकत आहे... आता बोला',
      'voice_processing': 'प्रहार एआय द्वारे प्रक्रिया सुरू आहे...',
      'voice_tap_to_speak': 'बोलण्यासाठी माइक दाबा',
      'voice_not_available': 'आवाज ओळख अनुपलब्ध, मजकूर मोड सुरू आहे.',
      'scenarios_title': 'निश्चित डेमो परिस्थिती',
      'demo_scenarios_title': 'निश्चित डेमो परिस्थिती',
      'reset_field_btn': 'शेत स्थिती रीसेट करा',
      'reset_scenario': 'शेत स्थिती रीसेट करा',
      'judge_mode_title': 'जज मोड',
      'judge_mode_badge': '12-टप्पे मूल्यमापन',
      'judge_mode_subtitle': 'हॅकाथॉन परीक्षकांसाठी 12 सत्यापित टप्प्यांचे मूल्यमापन.',
      'judge_mode_btn': 'जज मोड (12 टप्पे)',
      'judge_mode_step': 'टप्पा',
      'judge_mode_next': 'पुढचा टप्पा',
      'judge_mode_reset': 'रीसेट करा आणि दुसरी परिस्थिती निवडा',
      'assistant_listening': 'ऐकत आहे... आता बोला',
      'assistant_chip_prediction': 'झोन निकालाचा अंदाज',
      'assistant_chip_analysis': 'संपूर्ण शेत कृषी विश्लेषण',
      'assistant_chip_compare': 'झोन 1 वि झोन 2 तुलना',
      'assistant_prediction_disclaimer': 'प्रहार परिस्थिती अंदाज • सूचक सिमुलेशन',
      'evidence_breakdown': 'कृषी पुरावा तपशील',
    },
    ...
    'pa': {
      ...
      'provider_ollama': 'ਓਲਾਮਾ ਕਵੇਨ3 8B',
      'provider_deterministic': 'ਪ੍ਰਹਾਰ ਨਿਯਮਿਤ ਇੰਜਣ',
      'scenario_estimate_label': 'ਪ੍ਰਹਾਰ ਸਥਿਤੀ ਅੰਦਾਜ਼ਾ (ਸਿਮੂਲੇਸ਼ਨ ਡੈਮੋ)',
      'scenario_estimate_disclaimer': 'ਸਥਿਤੀ ਦੇ ਅੰਦਾਜ਼ੇ ਕੇਵਲ ਸਿਮੂਲੇਟ ਕੀਤੇ ਅਨੁਮਾਨ ਹਨ, ਕੋਈ ਪੱਕਾ ਨਤੀਜਾ ਨਹੀਂ।',
      'evidence_breakdown_title': 'ਖੇਤੀ ਸਬੂਤ ਵੇਰਵਾ',
      'metric_col': 'ਮਾਪਦੰਡ',
      'observed_col': 'ਦੇਖਿਆ ਗਿਆ',
      'threshold_col': 'ਸੀਮਾ',
      'status_col': 'ਸਥਿਤੀ',
      'voice_listening': 'ਸੁਣ ਰਿਹਾ ਹੈ... ਹੁਣ ਬੋਲੋ',
      'voice_processing': 'ਪ੍ਰਹਾਰ ਏਆਈ ਰਾਹੀਂ ਆਵਾਜ਼ ਦੀ ਜਾਂਚ ਹੋ ਰਹੀ ਹੈ...',
      'voice_tap_to_speak': 'ਬੋਲਣ ਲਈ ਮਾਈਕ ਦਬਾਓ',
      'voice_not_available': 'ਆਵਾਜ਼ ਸੇਵਾ ਉਪਲਬਧ ਨਹੀਂ ਹੈ, ਟੈਕਸਟ ਮੋਡ ਵਰਤੋ।',
      'scenarios_title': 'ਨਿਯਮਿਤ ਡੈਮੋ ਸਥਿਤੀਆਂ',
      'demo_scenarios_title': 'ਨਿਯਮਿਤ ਡੈਮੋ ਸਥਿਤੀਆਂ',
      'reset_field_btn': 'ਖੇਤ ਸਥਿਤੀ ਰੀਸੈਟ ਕਰੋ',
      'reset_scenario': 'ਖੇਤ ਸਥਿਤੀ ਰੀਸੈਟ ਕਰੋ',
      'judge_mode_title': 'ਜੱਜ ਮੋਡ',
      'judge_mode_badge': '12-ਪੜਾਅ ਮੁਲਾਂਕਣ',
      'judge_mode_subtitle': 'ਹੈਕਾਥੌਨ ਜੱਜਾਂ ਲਈ 12 ਪ੍ਰਮਾਣਿਤ ਪੜਾਵਾਂ ਦਾ ਮੁਲਾਂਕਣ ਪ੍ਰਵਾਹ।',
      'judge_mode_btn': 'ਜੱਜ ਮੋਡ (12 ਪੜਾਅ)',
      'judge_mode_step': 'ਪੜਾਅ',
      'judge_mode_next': 'ਅਗਲਾ ਪੜਾਅ',
      'judge_mode_reset': 'ਰੀਸੈਟ ਕਰੋ ਅਤੇ ਹੋਰ ਸਥਿਤੀ ਚੁਣੋ',
      'assistant_listening': 'ਸੁਣ ਰਿਹਾ ਹੈ... ਹੁਣ ਬੋਲੋ',
      'assistant_chip_prediction': 'ਜ਼ੋਨ ਨਤੀਜੇ ਦਾ ਅੰਦਾਜ਼ਾ',
      'assistant_chip_analysis': 'ਸਾਰਾ ਖੇਤ ਖੇਤੀਬਾੜੀ ਵਿਸ਼ਲੇਸ਼ਣ',
      'assistant_chip_compare': 'ਜ਼ੋਨ 1 ਬਨਾਮ ਜ਼ੋਨ 2 ਤੁਲਨਾ',
      'assistant_prediction_disclaimer': 'ਪ੍ਰਹਾਰ ਸਥਿਤੀ ਅੰਦਾਜ਼ਾ • ਸੰਕੇਤਕ ਸਿਮੂਲੇਸ਼ਨ',
      'evidence_breakdown': 'ਖੇਤੀ ਸਬੂਤ ਵੇਰਵਾ',
    },
  };
